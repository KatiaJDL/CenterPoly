...
python test.py polydet --exp_id iou_loss_TEST --nbr_points 16 --dataset cityscapes --arch smallhourglass --load_model ../exp/cityscapes/polydet/ou_loss/model_best.pth
