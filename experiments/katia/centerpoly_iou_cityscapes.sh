...
python main.py polydet --val_intervals 24 --exp_id iou_l1_loss --elliptical_gt --poly_weight 1 --nbr_points 16 --dataset cityscapes --arch smallhourglass  --batch_size 4 --master_batch 4 --lr 2e-4 --load_model ../models/ctdet_coco_hg.pth --poly_loss l1+iou

python test.py polydet --exp_id pretrained_iou_loss_SUBMIT --nbr_points 16 --dataset cityscapes --arch smallhourglass --load_model ../exp/cityscapes/polydet/iou_l1_loss/model_best.pth

#with pretrained CenterPoly and polar representation
python main.py polydet --val_intervals 24 --exp_id pretrained_iou_loss_polar --elliptical_gt --poly_weight 1 --nbr_points 16 --dataset cityscapes --arch smallhourglass  --batch_size 4 --master_batch 4 --lr 2e-4 --load_model ../exp/cityscapes/polydet/from_ctdet_smhg_1cnv_16_pw1_B_cospolar/model_best.pth --poly_loss iou --rep polar
